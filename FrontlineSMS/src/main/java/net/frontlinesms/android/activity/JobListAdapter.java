 ...
 */
public class JobListAdapter extends BaseListAdapter {
    ...
    public void bindView(final View view, final Context context, Cursor cursor) {
        ...
        // recipient
        int columnIndex = cursor.getColumnIndex("recipient");
        final String recipient = cursor.getString(columnIndex);
        holder.txtTitle.setText(recipient);
